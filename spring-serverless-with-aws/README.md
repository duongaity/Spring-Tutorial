# spring-serverless-with-aws serverless API
The spring-serverless-with-aws project, created with [`aws-serverless-java-container`](https://github.com/awslabs/aws-serverless-java-container).
